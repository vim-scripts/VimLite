...
def GetCalltipsFromResults(sFuncName, results):
    lCalltips = []
...
class VIMClangCCIndex(object):
    ...
    def GetCalltipsFromCacheCCResults(self, sFuncName):
        return GetCalltipsFromResults(sFuncName, self.cacheCCResults.results)

    def GetCalltipsFromCacheFilteredResults(self, sFuncName):
        return GetCalltipsFromResults(sFuncName, self.cacheResults)
