...
extern void StrLStripMod(char *pszSrc, const char *pszChars);
extern void StrRStripMod(char *pszSrc, const char *pszChars);
extern void StrStripMod(char *pszSrc, const char *pszChars);
#define StrStripSpaceMod(pszSrc) StrStripMod(pszSrc, " \f\n\r\t\v")
